...
const Services = () => {
  const services = [
    {
      ...
      icon: <FaFileInvoice className="text-4xl text-blue-600 mb-4" />,
      bgClass: "bg-gray-100",
    ...
    },
    {
      ...
      icon: <FaCreditCard className="text-4xl text-blue-600 mb-4" />,
      bgClass: "bg-blue-100",
    ...
    },
    {
      ...
      icon: <FaSuitcase className="text-4xl text-blue-600 mb-4" />,
      bgClass: "bg-gray-100",
      hoverBgClass: "hover:bg-blue-200", // Added hover background color
    },
    {
    ...
    },
    {
      ...
      icon: <FaFileAlt className="text-4xl text-blue-600 mb-4" />,
      bgClass: "bg-gray-100",
      hoverBgClass: "hover:bg-blue-200", // Added hover background color
    },
    {
    ...
    },
    {
      ...
      icon: <FaCoins className="text-4xl text-blue-600 mb-4" />,
      bgClass: "bg-gray-100",
      hoverBgClass: "hover:bg-blue-200", // Added hover background color
    },
    {
  ...
  return (
    <div className="max-w-screen-xl lg:mx-auto mx-4 py-10">
      <div className="text-center mb-10">
        <p className="font-bold text-blue-600 uppercase">Our Services</p>
        ...
        {services.map((service, index) => (
          ...
          >
            <div className="flex flex-col items-center">
              {service.icon}
              <h2 className="text-xl font-bold text-blue-600 mb-3 text-center">
                {service.title}
              </h2>
            </div>
